 ...
 */
@RestController
public class Neo4jNativeController implements Controller {

	private static final Logger LOG = LoggerFactory.getLogger(Neo4jNativeController.class);
	...
	// method;count;level/needproperties;duration
}
